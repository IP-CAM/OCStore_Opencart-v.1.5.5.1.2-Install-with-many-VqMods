          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea rows="25" cols="100" name="product_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>
              <tr>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                 ...
                 <td class="right">Цена в валюте по умолчанию: <select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]">
...
function addOptionValue(option_row) {	
	...
	html += '    </select></td>';
                 	...
                 	html += '    <td class="right">Цена в валюте по умолчанию:<select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][price_prefix]">';
